...
console.log("MONGODB_URI first 50 chars:", MONGODB_URI.substring(0, 50));

// MongoDB Event Listeners (CRITICAL!)
...
try {
  ...
  invoiceRoutes = require("express").Router();
  invoiceRoutes.get("/", (req, res) => {
    res.json({
      message: "Fallback invoices route",
...
app.get("/api/health", (req, res) => {
  ...
  console.log(`GET /api/health - DB State: ${dbState}`);
